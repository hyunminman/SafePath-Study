...
[스크린샷 삽입: 사용자 브라우저 화면에 세션 쿠키가 노출된 팝업 증명 화면]

[스크린샷 삽입: 탈취한 JSESSIONID 쿠키를 개발자 도구를 통해 조작하여 로그인 인증을 우회한 화면]
...
[스크린샷 삽입: CSRF 공격을 유도하기 위해 구성한 HTML 폼 소스 코드]

[스크린샷 삽입: 시스템 사양 및 디렉토리 구조가 노출된 에러 페이지 화면]
